...
function Logo({ compact = false }: { compact?: boolean }) {
  return (
    <div className={cn("leading-none", compact ? "scale-90 origin-left" : "") }>
  ...
  return (
    <div className="relative overflow-x-hidden bg-[color:var(--dark)] text-[color:var(--cream)]">
      ...
      <main id="main-content" className="relative z-10">
        <section id="top" className="relative scroll-mt-28 flex min-h-screen items-center px-4 pb-16 pt-28 sm:px-6 lg:px-8">
          <motion.div style={{ y: heroParallax }} className="absolute inset-x-4 inset-y-8 sm:inset-x-6 lg:inset-x-8">
            <HeroScene />
          </motion.div>

          <div className="relative mx-auto grid w-full max-w-7xl gap-12 lg:grid-cols-[minmax(0,1fr)_340px] lg:items-end">
